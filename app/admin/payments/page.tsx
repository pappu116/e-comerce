...
// import { 
//   RotateCcw, X, ShieldAlert, CheckCircle2, 
//   AlertCircle, DollarSign, ArrowRight, Info
// } from 'lucide-react';
...
//   const transactions = [
//     { id: "TXN-8821", user: "Alex M.", amount: 120.00, status: "Completed", date: "2m ago" },
//     { id: "TXN-8822", user: "Sarah K.", amount: 45.00, status: "Pending", date: "15m ago" },
//     { id: "TXN-8823", user: "James O.", amount: 2400.00, status: "Completed", date: "1h ago" },
//   ];
...
//   return (
//     <div className="p-8 bg-[#f8fafc] dark:bg-[#05070a] min-h-screen font-sans">
      
//       {/* TABLE SECTION */}
//       <div className="bg-white dark:bg-[#0f1117] rounded-[32px] border border-slate-100 dark:border-slate-800 overflow-hidden shadow-sm">
//         <table className="w-full text-left border-collapse">
//           <thead>
//             <tr className="border-b border-slate-50 dark:border-slate-800 bg-slate-50/50 dark:bg-white/5">
//               <th className="px-8 py-6 text-[10px] font-black uppercase text-slate-400 tracking-widest">Transaction Info</th>
//               <th className="px-8 py-6 text-[10px] font-black uppercase text-slate-400 tracking-widest">Amount</th>
//               <th className="px-8 py-6 text-[10px] font-black uppercase text-slate-400 tracking-widest">Refund Status</th>
...
//                     <p className="text-xs font-black dark:text-white">{tx.user}</p>
//                     <p className="text-[9px] font-bold text-slate-400 mt-1 uppercase tracking-tighter">ID: {tx.id} • {tx.date}</p>
//                 </td>
//                 <td className="px-8 py-5">
//                     <span className="text-sm font-black dark:text-white tracking-tighter">${tx.amount}</span>
//                 </td>
//                 <td className="px-8 py-5">
//                     <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase ${tx.status === 'Completed' ? 'bg-emerald-50 text-emerald-500' : 'bg-slate-100 text-slate-400'}`}>
//                         {tx.status}
//                     </span>
//                 </td>
...
//                           className="flex items-center gap-2 ml-auto px-4 py-2 bg-rose-50 dark:bg-rose-500/10 text-rose-600 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-600 hover:text-white transition-all shadow-sm"
//                         >
...
//           {/* Modal Content */}
//           <div className="relative w-full max-w-lg bg-white dark:bg-[#0f1117] rounded-[40px] shadow-2xl border border-slate-100 dark:border-slate-800 p-8 md:p-10 animate-in fade-in zoom-in duration-300">
            
//             {/* Close Button */}
//             <button onClick={() => setIsModalOpen(false)} className="absolute top-6 right-6 p-2 text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all">
//               <X size={24} />
//             </button>

//             <div className="flex items-center gap-4 mb-8">
//                 <div className="p-4 bg-rose-50 dark:bg-rose-500/10 text-rose-600 rounded-2xl">
//                     <ShieldAlert size={32} />
//                 </div>
//                 <div>
//                     <h2 className="text-2xl font-black italic uppercase tracking-tighter dark:text-white">Process <span className="text-rose-600">Refund</span></h2>
//                     <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Transaction: {selectedTx.id}</p>
//                 </div>
//             </div>
...
//                     <div>
//                         <p className="text-[10px] font-black text-slate-400 uppercase">Amount to Refund</p>
//                         <h3 className="text-2xl font-black text-slate-900 dark:text-white tracking-tighter italic">${selectedTx.amount}</h3>
//                     </div>
//                     <div className="text-right">
//                         <p className="text-[10px] font-black text-slate-400 uppercase">Customer</p>
//                         <p className="text-xs font-bold dark:text-white">{selectedTx.user}</p>
//                     </div>
//                 </div>

//                 {/* Refund Reason Selection */}
//                 <div className="space-y-3">
//                     <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Reason for Refund</label>
//                     <select className="w-full p-4 rounded-2xl bg-slate-50 dark:bg-[#080a0f] border-2 border-slate-100 dark:border-slate-800 dark:text-white text-sm font-bold outline-none focus:border-rose-500 transition-all appearance-none">
//                         <option>Customer Request (Order Cancel)</option>
//                         <option>Product Out of Stock</option>
//                         <option>Defective Product Received</option>
...
//                     <button className="flex-1 p-4 rounded-2xl border-2 border-rose-500 bg-rose-50/50 dark:bg-rose-500/5 text-rose-600 text-[10px] font-black uppercase tracking-widest">
//                         Full Refund
//                     </button>
//                     <button className="flex-1 p-4 rounded-2xl border-2 border-slate-100 dark:border-slate-800 text-slate-400 text-[10px] font-black uppercase tracking-widest">
//                         Partial Refund
//                     </button>
//                 </div>

//                 {/* Warning Text */}
//                 <div className="flex gap-3 p-4 bg-amber-50 dark:bg-amber-500/5 rounded-2xl border border-amber-100 dark:border-amber-900/30">
//                     <AlertCircle size={16} className="text-amber-500 shrink-0" />
//                     <p className="text-[10px] font-bold text-amber-600/80 leading-relaxed uppercase">
//                         Warning: This action will return funds directly to the customer's original payment method. This cannot be undone.
//                     </p>
//                 </div>
//             </div>
...
//                 <button onClick={() => setIsModalOpen(false)} className="flex-1 py-4 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all">
//                     Cancel
//                 </button>
//                 <button 
//                   onClick={() => { alert('Refund Processed!'); setIsModalOpen(false); }}
//                   className="flex-[2] py-4 bg-rose-600 hover:bg-rose-700 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-rose-200 dark:shadow-none transition-all active:scale-95"
//                 >
//                     Confirm & Refund Fund
//                 </button>
//             </div>
...
//   Download, Filter, Search, MoreHorizontal, CheckCircle2, 
//   Clock, AlertCircle, RotateCcw, FileText, ChevronRight,
...
//           </h1>
//           <p className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] mt-1">Real-time revenue & transaction ledger</p>
//         </div>
//         <div className="flex gap-3">
//           <button className="flex items-center gap-2 bg-white dark:bg-[#0f1117] border border-slate-200 dark:border-slate-800 px-5 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest dark:text-white hover:bg-slate-50 transition-all shadow-sm">
//             <Download size={14} /> Settlement Report
//           </button>
//           <button className="flex items-center gap-2 bg-indigo-600 text-white px-5 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-indigo-500/20 hover:scale-105 transition-all">
...
//         <FinanceCard title="Net Profit (After Tax)" value="$94,120.50" trend="+10.5%" icon={<TrendingUp size={20}/>} color="emerald" />
//         <FinanceCard title="Gateway Fees" value="$3,240.12" trend="+2.1%" icon={<Percent size={20}/>} color="amber" />
//         <FinanceCard title="Refunded Volume" value="$1,120.00" trend="-4.5%" icon={<RotateCcw size={20}/>} color="rose" />
//       </div>

//       <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
//         {/* 3. REVENUE FLOW CHART (MINI) */}
//         <div className="lg:col-span-2 bg-white dark:bg-[#0f1117] p-8 rounded-[40px] border border-slate-100 dark:border-slate-800 shadow-sm relative overflow-hidden">
//           <div className="flex justify-between items-center mb-8 relative z-10">
//             <div>
//               <h3 className="font-black text-sm uppercase tracking-widest dark:text-white">Revenue Analysis</h3>
//               <p className="text-[10px] font-bold text-slate-400 uppercase mt-1">Comparison: Gross vs Net</p>
//             </div>
//             <div className="flex gap-4">
//               <div className="flex items-center gap-2 text-[10px] font-black uppercase text-indigo-600"><span className="w-2 h-2 rounded-full bg-indigo-600"></span> Gross</div>
//               <div className="flex items-center gap-2 text-[10px] font-black uppercase text-emerald-500"><span className="w-2 h-2 rounded-full bg-emerald-500"></span> Net</div>
//             </div>
//           </div>
//           {/* Custom Visual Bars */}
//           <div className="h-48 flex items-end gap-2 px-2">
//             {[45, 70, 55, 90, 65, 85, 100, 75, 95, 60, 80, 110].map((val, i) => (
//               <div key={i} className="flex-1 flex flex-col gap-1 items-center h-full justify-end group">
//                 <div style={{ height: `${val*0.7}%` }} className="w-full bg-emerald-400/20 dark:bg-emerald-500/10 rounded-t-sm group-hover:bg-emerald-500/40 transition-all"></div>
//                 <div style={{ height: `${val}%` }} className="w-full bg-indigo-600 rounded-t-md group-hover:brightness-125 transition-all shadow-lg"></div>
//               </div>
//             ))}
//           </div>
//         </div>
...
//           <h3 className="font-black text-sm uppercase tracking-widest dark:text-white mb-6">Payment Gateways</h3>
//           <div className="space-y-6">
//             <MethodRow name="Stripe (Cards)" percent="65%" amount="$83,479" color="bg-indigo-600" />
//             <MethodRow name="PayPal" percent="20%" amount="$25,686" color="bg-blue-500" />
//             <MethodRow name="Apple/Google Pay" percent="10%" amount="$12,843" color="bg-slate-900" />
//             <MethodRow name="Crypto (BitPay)" percent="5%" amount="$6,422" color="bg-amber-500" />
//           </div>
//         </div>
//       </div>

//       {/* 5. MAIN TRANSACTION LEDGER */}
...
//         {/* Table Filters */}
//         <div className="p-6 border-b border-slate-50 dark:border-slate-800 flex flex-wrap justify-between items-center gap-4">
//           <div className="flex gap-2">
//             {['all', 'completed', 'pending', 'refunded'].map((tab) => (
//               <button 
//                 key={tab}
//                 onClick={() => setActiveTab(tab)}
//                 className={`px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/20' : 'text-slate-400 hover:bg-slate-50 dark:hover:bg-white/5'}`}
//               >
//                 {tab}
//               </button>
//             ))}
...
//              <input type="text" placeholder="Search Transaction ID, User, or Email..." className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-[#080a0f] rounded-xl text-[10px] font-bold outline-none border-2 border-transparent focus:border-indigo-600 transition-all dark:text-white" />
//           </div>
//         </div>
...
//               <tr>
//                 <th className="px-8 py-5 text-[10px] font-black uppercase text-slate-400 tracking-widest">Client & ID</th>
//                 <th className="px-8 py-5 text-[10px] font-black uppercase text-slate-400 tracking-widest">Gateway</th>
//                 <th className="px-8 py-5 text-[10px] font-black uppercase text-slate-400 tracking-widest">Amount & Tax</th>
...
//             </thead>
//             <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50">
//                <TransactionItem name="Alex Murphy" email="alex@example.com" id="TRX-99281" method="Visa •••• 4242" amount="1,200.00" fee="36.00" status="Completed" date="Mar 24, 2024" />
//                <TransactionItem name="Sarah Jenkins" email="sarah.j@web.com" id="TRX-99282" method="PayPal Wallet" amount="450.00" fee="13.50" status="Pending" date="Mar 23, 2024" />
//                <TransactionItem name="James Bond" email="007@mi6.com" id="TRX-99283" method="MasterCard •••• 0007" amount="5,000.00" fee="150.00" status="Refunded" date="Mar 22, 2024" />
//             </tbody>
//           </table>
//         </div>
//       </div>
...
//           {trend.includes('+') ? <ArrowUpRight size={10} /> : <ArrowDownRight size={10} />} {trend}
//         </div>
//       </div>
...
//         <span className="dark:text-white">{amount} <span className="text-[9px] text-slate-400">({percent})</span></span>
//       </div>
...
// function TransactionItem({ name, email, id, method, amount, fee, status, date }: any) {
...
//           <div className="w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[10px] font-black text-slate-500">{name.charAt(0)}</div>
//           <div>
...
//       </td>
//       <td className="px-8 py-5">
//         <p className="text-xs font-bold dark:text-white">{method}</p>
//         <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Authorization Success</p>
//       </td>
//       <td className="px-8 py-5">
//         <p className="text-sm font-black dark:text-white tracking-tighter">${amount}</p>
//         <p className="text-[9px] font-bold text-rose-500 uppercase">Fee: -${fee}</p>
//       </td>
//       <td className="px-8 py-5">
...
//            <button title="Download Invoice" className="p-2 text-slate-400 hover:bg-indigo-600 hover:text-white rounded-lg transition-all"><FileText size={16} /></button>
//            <button title="View Transaction" className="p-2 text-slate-400 hover:bg-indigo-600 hover:text-white rounded-lg transition-all"><ChevronRight size={16} /></button>
//         </div>
//       </td>
//     </tr>
//   );
