// "use client";
// import { BellRing, Truck, Tag, CreditCard, ShoppingBag } from "lucide-react";
...
//       desc: "The 'Premium Hoodie' you liked is back in stock!", 
//       icon: ShoppingBag, 
...
//         <h3 className="text-3xl font-black tracking-tight text-white">Notifications</h3>
...
//             key={i} 
//             whileHover={{ x: 5 }}
//             className="flex gap-6 p-6 bg-white/5 border border-white/10 rounded-[2.5rem] hover:bg-white/[0.08] transition-all cursor-pointer group relative overflow-hidden"
//           >
...
//              <div className={`p-4 rounded-2xl shrink-0 h-fit ${n.color}`}>
//                 <n.icon size={24} />
//              </div>
             
//              <div className="flex-1">
//                 <div className="flex justify-between items-start">
//                   <h4 className="font-black text-lg text-slate-100 group-hover:text-indigo-400 transition-colors">
//                     {n.title}
//                   </h4>
//                   <span className="text-[10px] text-slate-600 font-black uppercase tracking-widest bg-white/5 px-3 py-1 rounded-full">
//                     {n.time}
//                   </span>
//                 </div>
//                 <p className="text-slate-400 mt-1 font-medium leading-relaxed max-w-md">
//                   {n.desc}
//                 </p>
//              </div>
             
//              <div className="w-2 h-2 bg-indigo-500 rounded-full mt-2 shadow-[0_0_15px_rgba(99,102,241,0.8)] shrink-0" />
//           </motion.div>
//         ))}
//       </div>
...
//             <p className="text-slate-500 font-bold">No new notifications yet.</p>
//         </div>
//       )}
//     </motion.div>
//   );
