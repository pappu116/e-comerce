// "use client";
// import { Lock, ShieldCheck, Eye, EyeOff, ShieldAlert } from "lucide-react";
...
//       <div className="p-8 bg-white/5 border border-white/10 rounded-[3rem] backdrop-blur-3xl shadow-2xl">
//         <div className="flex items-center gap-4 mb-10">
//           <div className="p-3 bg-indigo-500/20 rounded-2xl text-indigo-500"><ShieldCheck size={30} /></div>
//           <div>
//             <h3 className="text-3xl font-black tracking-tight">Security & Privacy</h3>
//             <p className="text-slate-500 font-bold">Manage your account safety and encryption</p>
//           </div>
//         </div>
        
//         <div className="space-y-6">
//            <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] flex justify-between items-center group transition-all hover:bg-white/[0.08]">
//               <div className="flex gap-5">
//                  <ShieldAlert className="text-indigo-400 mt-1" />
//                  <div>
//                     <p className="font-black text-xl">Two-Factor Authentication</p>
//                     <p className="text-sm text-slate-500 font-medium mt-1">Recommended for high security.</p>
//                  </div>
//               </div>
//               <div className="w-14 h-7 bg-indigo-600 rounded-full relative cursor-pointer shadow-[0_0_20px_rgba(99,102,241,0.3)]">
...
//                    <input type={showPass ? "text" : "password"} placeholder="Current Password" className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl focus:outline-none focus:border-indigo-500 transition-all font-bold" />
//                    <button onClick={() => setShowPass(!showPass)} className="absolute right-5 top-5 text-slate-500">
//                       {showPass ? <EyeOff size={20} /> : <Eye size={20} />}
//                    </button>
//                  </div>
//                  <input type="password" placeholder="New Password" className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl focus:outline-none focus:border-indigo-500 transition-all font-bold" />
//                  <button className="py-5 bg-indigo-600 text-white rounded-2xl font-black text-lg hover:bg-indigo-500 transition-all shadow-2xl active:scale-95">Update Password</button>
//               </div>
//            </div>
//         </div>
//       </div>
...
// "use client";
// import { Lock, ShieldCheck, Eye, EyeOff, ShieldAlert, Smartphone, Globe, Trash2, X, CheckCircle2 } from "lucide-react";
// import { useState } from "react";
...
//     if (!is2FAEnabled) {
//       setShowOTPModal(true); // এনাবল করার আগে OTP চাবে
//     } else {
...
//       <div className="p-10 bg-white/5 border border-white/10 rounded-[3.5rem] backdrop-blur-3xl shadow-2xl relative overflow-hidden">
        
//         {/* Header */}
//         <div className="flex items-center gap-5 mb-12">
//           <div className="p-4 bg-indigo-500/20 rounded-[1.5rem] text-indigo-500 shadow-inner">
//             <ShieldCheck size={32} />
//           </div>
//           <div>
//             <h3 className="text-3xl font-black tracking-tight text-white">Security & Privacy</h3>
//             <p className="text-slate-500 font-bold text-sm">Manage your account safety, encryption and sessions</p>
//           </div>
//         </div>

//         <div className="space-y-8">
//           {/* --- Two-Factor Authentication --- */}
//           <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] flex flex-wrap justify-between items-center group transition-all hover:bg-white/[0.08] gap-6">
//             <div className="flex gap-5">
//               <div className={`p-3 rounded-2xl ${is2FAEnabled ? 'bg-green-500/10 text-green-500' : 'bg-amber-500/10 text-amber-400'}`}>
//                 <Smartphone size={24} />
//               </div>
//               <div>
//                 <p className="font-black text-xl text-slate-100 flex items-center gap-2">
//                   Two-Factor Authentication 
...
//               className={`w-16 h-8 rounded-full relative cursor-pointer transition-all duration-300 ${is2FAEnabled ? 'bg-indigo-600 shadow-[0_0_20px_rgba(99,102,241,0.4)]' : 'bg-slate-800'}`}
//             >
//               <motion.div 
//                 animate={{ x: is2FAEnabled ? 34 : 4 }}
...
//                 <div className="relative">
//                   <input type={showPass ? "text" : "password"} placeholder="Current Password" className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl focus:outline-none focus:border-indigo-500 transition-all font-bold text-white text-sm" />
//                   <button onClick={() => setShowPass(!showPass)} className="absolute right-5 top-5 text-slate-500 hover:text-indigo-400 transition-colors">
//                     {showPass ? <EyeOff size={20} /> : <Eye size={20} />}
//                   </button>
//                 </div>
//                 <input type="password" placeholder="New Password" className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl focus:outline-none focus:border-indigo-500 transition-all font-bold text-white text-sm" />
//                 <button className="w-full py-5 bg-indigo-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-indigo-500 transition-all shadow-xl active:scale-95">Update Password</button>
//               </div>
//             </div>

//             {/* --- Active Sessions (Professional Feature) --- */}
//             <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-6">
//               <p className="font-black text-xl text-slate-100 flex items-center gap-2">
//                 <Globe size={18} className="text-indigo-400" /> Login Devices
//               </p>
//               <div className="space-y-4">
//                 <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
//                    <div className="flex gap-3">
//                       <Smartphone size={18} className="text-slate-500 mt-1" />
//                       <div>
//                         <p className="text-xs font-black text-slate-200">iPhone 15 Pro • Dhaka, BD</p>
//                         <p className="text-[10px] text-green-500 font-bold uppercase tracking-tighter">Current Session</p>
//                       </div>
//                    </div>
//                 </div>
//                 <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5 opacity-60">
//                    <div className="flex gap-3">
//                       <Globe size={18} className="text-slate-500 mt-1" />
//                       <div>
//                         <p className="text-xs font-black text-slate-200">Chrome on Windows • Sylhet, BD</p>
//                         <p className="text-[10px] text-slate-500 font-bold uppercase tracking-tighter">Last active: 2 hours ago</p>
//                       </div>
//                    </div>
//                    <button className="text-[10px] font-black text-red-400 hover:underline uppercase">Logout</button>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//              <div className="p-8 bg-red-500/5 border border-red-500/10 rounded-[2.5rem] flex justify-between items-center group">
//                 <div>
//                    <p className="font-black text-xl text-red-500 flex items-center gap-2">
//                      <Trash2 size={20} /> Delete Account
//                    </p>
//                    <p className="text-xs text-slate-500 font-bold mt-1">Once deleted, you will lose all your order history and rewards.</p>
//                 </div>
//                 <button className="px-6 py-3 border border-red-500/20 text-red-500 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all">Deactivate</button>
//              </div>
//           </div>
//         </div>
//       </div>
...
//             <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 20 }} className="bg-[#0f172a] border border-white/10 w-full max-w-md rounded-[3rem] p-10 relative z-10 text-center">
//               <button onClick={() => setShowOTPModal(false)} className="absolute top-6 right-6 text-slate-500 hover:text-white"><X size={20} /></button>
//               <div className="w-16 h-16 bg-indigo-500/20 rounded-2xl flex items-center justify-center text-indigo-500 mx-auto mb-6">
//                 <Smartphone size={32} />
//               </div>
//               <h4 className="text-2xl font-black text-white">Verify Your Phone</h4>
//               <p className="text-slate-500 text-sm font-bold mt-2">We sent a 4-digit code to your phone <br/> +880 1700-000000</p>
              
//               <div className="flex justify-center gap-4 my-8">
//                 {otp.map((digit, idx) => (
//                   <input key={idx} type="text" maxLength={1} className="w-14 h-16 bg-white/5 border border-white/10 rounded-2xl text-center text-2xl font-black text-white focus:border-indigo-500 outline-none transition-all" />
//                 ))}
//               </div>

//               <button onClick={verifyOTP} className="w-full py-5 bg-indigo-600 text-white rounded-[2rem] font-black uppercase tracking-widest shadow-xl shadow-indigo-600/20 hover:bg-indigo-500 transition-all">Enable 2FA Now</button>
//               <p className="mt-6 text-xs text-slate-500 font-bold cursor-pointer hover:text-indigo-400 transition-colors uppercase tracking-tighter">Didn't get code? Resend SMS</p>
//             </motion.div>
//           </div>
//         )}
//       </AnimatePresence>
