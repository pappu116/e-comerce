// "use client";
// import { User, Phone, Calendar, Mail, Settings, Camera } from "lucide-react";

// export default function SettingsSection({ user }: any) {
//   return (
//     <div className="p-10 bg-white/5 border border-white/10 rounded-[3rem] space-y-10 shadow-2xl backdrop-blur-3xl">
//       <div className="flex items-center justify-between">
//         <div className="flex items-center gap-4">
//             <div className="p-3 bg-indigo-500/20 rounded-2xl text-indigo-500"><Settings size={30} /></div>
//             <h3 className="text-3xl font-black tracking-tight">Account Profile</h3>
//         </div>
//         <button className="p-4 bg-white/5 rounded-full hover:bg-indigo-500 transition-all text-slate-400 hover:text-white border border-white/10">
//             <Camera size={20} />
//         </button>
//       </div>
...
//         {[
//             { label: "Legal Name", val: user?.name, icon: User, dis: false },
//             { label: "Email Address", val: user?.email, icon: Mail, dis: true },
//             { label: "Phone Number", val: "+880 1700-000000", icon: Phone, dis: false },
//             { label: "Date of Birth", val: "1998-06-12", icon: Calendar, dis: false, type: "date" }
//         ].map((field, i) => (
//             <div key={i} className="space-y-3">
//                 <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest ml-2">{field.label}</label>
//                 <div className={`flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl ${field.dis && 'opacity-50 cursor-not-allowed'}`}>
//                     <field.icon size={20} className="text-indigo-500" />
//                     <input type={field.type || "text"} defaultValue={field.val} disabled={field.dis} className="bg-transparent border-none outline-none font-bold w-full text-white" />
//                 </div>
//             </div>
//         ))}
//       </div>
      
//       <button className="px-12 py-5 bg-indigo-600 rounded-2xl font-black text-lg hover:bg-indigo-500 transition-all shadow-2xl active:scale-95">
//         Save Changes
//       </button>
//     </div>
//   );
...
//   return (
//     <div className="relative p-10 bg-white/5 border border-white/10 rounded-[3rem] space-y-10 shadow-2xl backdrop-blur-3xl overflow-hidden">
...
//             className="absolute top-6 left-1/2 -translate-x-1/2 bg-green-500 text-white px-6 py-3 rounded-full flex items-center gap-3 shadow-xl z-50 font-black text-xs uppercase tracking-widest"
//           >
...
//             <div className="p-3 bg-indigo-500/20 rounded-2xl text-indigo-500"><Settings size={30} /></div>
//             <div>
//               <h3 className="text-3xl font-black tracking-tight text-white">Account Profile</h3>
//               <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">Manage your identity and privacy</p>
//             </div>
//         </div>

//         <div className="relative group">
//           <input type="file" ref={fileInputRef} onChange={handleFileChange} className="hidden" accept="image/*" />
//           <div className="w-20 h-20 rounded-3xl overflow-hidden border-2 border-indigo-500/30 bg-zinc-900 flex items-center justify-center">
...
//             className="absolute -bottom-2 -right-2 p-3 bg-indigo-600 rounded-2xl text-white shadow-xl hover:bg-indigo-500 transition-all border-4 border-[#0f172a] group-active:scale-90"
//           >
//             <Camera size={16} />
//           </button>
//         </div>
...
//             <div key={i} className="space-y-3">
//                 <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest ml-2">{field.label}</label>
//                 <div className={`flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl transition-all focus-within:border-indigo-500/50 ${field.dis && 'opacity-50 cursor-not-allowed'}`}>
//                     <field.icon size={20} className="text-indigo-500 shrink-0" />
//                     <input 
//                       type={field.type || "text"} 
//                       defaultValue={field.val} 
//                       disabled={field.dis} 
//                       placeholder={field.placeholder}
//                       className="bg-transparent border-none outline-none font-bold w-full text-white placeholder:text-slate-600" 
//                     />
//                 </div>
//             </div>
//         ))}

//         {/* --- অতিরিক্ত প্রফেশনাল ফিল্ডস --- */}
//         <div className="space-y-3">
//           <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest ml-2">Gender</label>
//           <div className="flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl">
//             <User size={20} className="text-indigo-500 shrink-0" />
//             <select className="bg-transparent border-none outline-none font-bold w-full text-white appearance-none">
...
//         <div className="space-y-3">
//           <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest ml-2">Language Preference</label>
//           <div className="flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl">
//             <Globe size={20} className="text-indigo-500 shrink-0" />
//             <select className="bg-transparent border-none outline-none font-bold w-full text-white appearance-none">
//               <option className="bg-[#0f172a]">English (US)</option>
//               <option className="bg-[#0f172a]">Bengali (BD)</option>
//             </select>
//           </div>
//         </div>
//       </div>
...
//            <p className="text-xs font-bold">Your data is encrypted and secure.</p>
//         </div>

//         <button 
//           onClick={handleSave}
//           disabled={isSaving}
//           className="px-12 py-5 bg-indigo-600 text-white rounded-2xl font-black text-lg hover:bg-indigo-500 transition-all shadow-2xl active:scale-95 disabled:opacity-50 flex items-center gap-3 uppercase tracking-widest text-sm"
//         >
//           {isSaving ? (
...
//   User, Phone, Calendar, Mail, Settings, Camera, 
//   ShieldCheck, Globe, Save, CheckCircle2, UserCircle2,
//   Fingerprint, Smartphone, Link as LinkIcon
// } from "lucide-react";
// import { motion, AnimatePresence } from "framer-motion";
...
//                 <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest ml-2">{field.label}</label>
//                 <div className={`flex items-center gap-4 p-5 bg-white/5 border border-white/10 rounded-2xl transition-all focus-within:border-indigo-500/50 ${field.dis && 'opacity-50 cursor-not-allowed'}`}>
//                     <field.icon size={20} className="text-indigo-400 shrink-0" />
//                     <input 
//                       type={field.type || "text"} 
//                       defaultValue={field.val} 
//                       disabled={field.dis} 
...
//             <select className="bg-transparent border-none outline-none font-bold w-full text-white appearance-none text-sm cursor-pointer">
//               <option className="bg-[#0f172a]">Male</option>
//               <option className="bg-[#0f172a]">Female</option>
//               <option className="bg-[#0f172a]">Other</option>
//             </select>
...
//         {/* Social Login Info Section */}
//         <div className="space-y-3">
//           <label className="text-[10px] text-slate-500 uppercase font-black tracking-widest ml-2">Social Connection</label>
//           <div className="flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded-2xl">
//             <div className="flex items-center gap-4">
//                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
//                   {/* Google Icon Example */}
//                   <svg className="w-4 h-4" viewBox="0 0 24 24"><path fill="white" d="M12.48 10.92v3.28h7.84c-.24 1.84-.9 3.47-1.92 4.64-1.2 1.2-3.08 2.47-5.92 2.47-4.41 0-8.08-3.57-8.08-8s3.67-8 8.08-8c2.41 0 4.17.95 5.48 2.2l2.35-2.35C18.18 2.9 15.45 1.5 12.48 1.5 6.48 1.5 1.5 6.48 1.5 12.5s4.98 11 10.98 11c3.23 0 5.67-1.07 7.55-3.04 1.95-1.95 2.57-4.73 2.57-7.1 0-.69-.05-1.34-.15-1.94h-9.94z"/></svg>
//                </div>
//                <div>
//                   <p className="text-xs font-black text-white">Connected via Google</p>
//                   <p className="text-[9px] text-green-500 font-bold uppercase tracking-tighter">Verified Account</p>
//                </div>
//             </div>
...
//           onClick={handleSave}
//           disabled={isSaving}
//           className="px-12 py-5 bg-indigo-600 text-white rounded-[2rem] font-black hover:bg-indigo-500 transition-all shadow-xl active:scale-95 disabled:opacity-50 flex items-center gap-3 uppercase tracking-widest text-sm"
//         >
//           {isSaving ? (
//             <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 1 }}><Settings size={20} /></motion.div>
//           ) : <Save size={20} />}
