...
//     <motion.div 
//       whileHover={{ y: -5 }}
//       className="p-8 bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 rounded-[2.5rem] md:rounded-[3.5rem] text-white shadow-2xl shadow-indigo-600/30 relative overflow-hidden group"
//     >
//       {/* Decorative Elements */}
//       <Zap className="absolute -right-6 -top-6 w-32 h-32 opacity-10 group-hover:rotate-12 group-hover:scale-125 transition-transform duration-1000" />
...
//             </div>
//             <div>
//               <p className="text-[10px] font-black uppercase tracking-[0.2em] opacity-80 leading-none mb-1">Tier Status</p>
//               <h4 className="text-2xl font-black italic tracking-tighter">GOLD MEMBER</h4>
//             </div>
//           </div>
//           <Gift size={24} className="opacity-50" />
//         </div>

//         <div className="mb-10 bg-black/20 p-6 rounded-[2rem] border border-white/10 backdrop-blur-sm">
//            <div className="flex justify-between items-end mb-3">
//              <div className="space-y-1">
//                <p className="text-[10px] font-black uppercase text-indigo-200">Current Points</p>
//                <h3 className="text-4xl font-black leading-none">{points}</h3>
//              </div>
//              <p className="text-[10px] font-black opacity-60">Goal: {target}</p>
//            </div>
           
//            <div className="w-full h-3 bg-black/30 rounded-full overflow-hidden p-[2px]">
//               <motion.div 
//                 initial={{ width: 0 }}
//                 animate={{ width: `${progress}%` }}
//                 transition={{ duration: 1.5, ease: "circOut" }}
//                 className="h-full bg-gradient-to-r from-teal-400 to-white rounded-full shadow-[0_0_15px_rgba(255,255,255,0.6)]" 
//               />
//            </div>
//            <p className="mt-3 text-[9px] font-bold text-center opacity-70 italic tracking-wide">
//              Earn {target - points} more points for a ৳৫০০ voucher!
//            </p>
//         </div>

//         <button className="w-full py-5 bg-white text-indigo-700 rounded-3xl font-black uppercase tracking-[0.2em] text-[10px] hover:bg-slate-100 transition-all shadow-xl active:scale-95">
//           Redeem Rewards
//         </button>
//       </div>
//     </motion.div>
